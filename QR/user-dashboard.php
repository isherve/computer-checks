                ...
                <div class="row">
                        ...
                        <div class="statistic-counter">
                            ...
                            <p class="counter">
                              <?php
                                      ...
                                      // Query to count the total number of computers
                                      $stmtComputers = $pdo->query("SELECT COUNT(DISTINCT sn) AS total_computers FROM computer_info");
                                      $totalComputers = $stmtComputers->fetchColumn();

                                      // Output the total number of computers and owners
                    ...
                    <div class="col-md-3">
                        <div class="statistic-counter">
                            ...
                            // Query to count the total number of unique owners
                            $stmtOwners = $pdo->query("SELECT COUNT(DISTINCT owname) AS total_owners FROM computer_info");
                            $totalOwners = $stmtOwners->fetchColumn();
