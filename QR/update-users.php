...
?>
    <h5 style="font-family:poppins;color:green;font-weight:bold;">Update User's Data</h5>

    <form action="updateUsersBack.php" method="post">
        <!-- Display the current data in form fields -->
        <label for="user_type">Role:</label>
        <p><input type="text" name="user_type" value="<?=$result->user_type ?>" required></p>

        <label for="names">Names:</label>
        <p><input type="text" name="names" value="<?=$result->names ?>" required></p>
        ...
        <input type="hidden" name="nid" value="<?=$result->nid ?>">
